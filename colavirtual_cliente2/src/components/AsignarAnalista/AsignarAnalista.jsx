...
import { validarFormato } from '../AsignarAnalista/validarFormato';
import { validarLlenado } from '../AsignarAnalista/validarLlenado';
import { getUsuario, postAnalista } from '../../services/'; // Mantenemos postSolicitud por si la lógica posterior lo requiere
  ...
  const handleSubmit = async (e) => {
          ...
          if (!Object.keys(err).length) {
              ...
              if (result.isConfirmed) {
                  ...
                  try {
                      setLoading(true);
                      const solicitud = await postAnalista(cuerpo);
