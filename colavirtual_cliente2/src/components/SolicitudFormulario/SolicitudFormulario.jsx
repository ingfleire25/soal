...
//import  {obtenerUsuarios}  from '../../../../colavirtual_api/src/controllers/sigaSQL.js'
//import { obtenerUsuarios } from '../../../../colavirtual_api/src/controllers/pruebaSQL'
...
const SolicitudFormulario = () => {
    ...
    //PROBAR ESTE PEDAZO DE CODIGO PARA DETENER EL FUNCIONAMIENTO SI EL USUARIO NO SE ENCUENTRA EN EL SISTEMA SIGA

        // const buscarSiga = async () => { 
        // try {
        //     if ( !input.cedula ) return false
        //     setLoading( true )
        //     const l = await consultaSiga(input.cedula);
        //     if (!l) { // Verifica si l es falso
        //       Swal.fire('Usuario no encontrado', '', 'error'); // Muestra un mensaje de error
        //       return; // Detiene la ejecución
        //     }
        //     console.log(l)
        //     return next(); // Continúa si l es verdadero
        //   } catch (error) {
        //     Swal.fire(error.statusText, '', 'error'); // Muestra el error si ocurre una excepción
        //   } finally {
        //     setLoading(false);
        //   }
        // }
...
// verificar el codigo con mucho cuidado.

// buenos dias guapeton
